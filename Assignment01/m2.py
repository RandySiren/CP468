...
def astar(maze, start, end, allow_diagonal_movement = False):
    ...
    while len(open_list) > 0:
        ...
        for new_position in adjacent_squares: # Adjacent squares
            ...
            if maze[node_position[0]][node_position[1]] != ' ' and maze[node_position[0]][node_position[1]] != '.' and maze[node_position[0]][node_position[1]] != 'P':
                continue
